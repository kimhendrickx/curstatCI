...
over all possible distribution functions $F$. As can be seen from its structure, the log likelihood only depends on the value that $F$ takes at the observed times points $T_i$. The values in between are irrelevant as long as $F$ is increasing. The MLE $F_n$ is a step function which can be characterized by the left derivative of the greatest convex minorant of the cumulative sumdiagran consisting of the points $P_0 = (0,0)$ and
